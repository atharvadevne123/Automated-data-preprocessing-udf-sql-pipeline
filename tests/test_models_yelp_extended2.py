...
class TestYelpReviewValidation:
    ...
    @pytest.mark.parametrize("stars,is_pos,is_neg", [
        (5.0, True, False),
        (4.0, True, False),
        (3.0, False, False),
        (2.0, False, True),
    ...
    @pytest.mark.parametrize("useful,funny,cool,expected_total", [
        (0, 0, 0, 0),
        (1, 2, 3, 6),
        (10, 0, 5, 15),
        (100, 100, 100, 300),
    ...
    def test_total_votes(self, useful, funny, cool, expected_total):
        r = YelpReview(
            review_id="r", user_id="u", business_id="b", stars=3,
...
class TestYelpBusinessValidation:
    ...
    def test_category_list_with_categories(self):
        b = YelpBusiness(
            business_id="b1", name="X", stars=4.0,
...
class TestYelpUserValidation:
    ...
    @pytest.mark.parametrize("review_count,avg_stars,expected", [
        (100, 4.0, True),
        (100, 4.5, True),
        (99, 4.5, False),
        (200, 3.9, False),
    ...
    def test_is_elite_candidate(self, review_count, avg_stars, expected):
        u = YelpUser(
            user_id="u1", name="Bob",
            review_count=review_count, average_stars=avg_stars,
        )
